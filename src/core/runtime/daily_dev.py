...
class Idea:
    ...
    plugin_template: dict[str, Any] | None = None
    rationale: str = ""
    ...
    """
        ...
        try:
            ...
            if engine:
                if not engine._beliefs:
                    ...
                    b = next(iter(engine._beliefs.values()))
                ...
                print("    ⊘ Skipped: no belief_engine")
        except Exception as e:
        ...
        try:
            ...
            if ledger:
                ...
                print("    ⊘ Skipped: no economic_ledger")
        except Exception as e:
