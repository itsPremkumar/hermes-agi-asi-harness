...
class ModelPortfolio:
    ...
    def _register_defaults(self) -> None:
        for m in (ModelEntry("frontier_reasoner", "reasoning", quality=0.95, cost_per_1k=0.01, avg_latency_s=20.0),
    ...
    def route(self, task_kind: str = "general", budget: str = "balanced") -> ModelEntry:
        ...
        cands = [m for m in self._models.values() if not role_hint or m.role in (role_hint, "fast")]
        if budget == "cheap":
